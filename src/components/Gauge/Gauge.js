        ...
        return <div className="Gauge">
            <svg className="Gauge-image" viewBox="0 0 260 140" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    ...
                    <path shapeRendering="geometricPrecision" transform={this.translateValueToDegrees(this.props.gaugeValue)} d="M138,140 C136.68171,138.207869 137.348377,101.541203 140,30 C142.666667,101.554614 143.333333,138.22128 142,140 C140,142.668079 139.977435,142.688196 138,140 Z" id="Needle" fill="#BD4932"></path>
